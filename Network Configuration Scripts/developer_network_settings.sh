...
networksetup -createlocation "VPN" populate 2> /dev/null
sleep 5
networksetup -switchtolocation "VPN" 2> /dev/null
sleep 2
...
# Create IMAnetwork location with no proxy settings
networksetup -createlocation "IMAnetwork" populate 2> /dev/null
networksetup -switchtolocation "IMAnetwork" 2> /dev/null
