...
if [[ ${pwrStatus} == "OK" ]] && [[ ${spaceStatus} == "OK" ]]; then
		...
		#Set key to Quit binary installer instead of reboot. Reboot will be handled by JAMF policy. This key is deleted as part of first boot script.
		...
		If you continue to experience this issue, please contact the TSD x.55777." -iconSize 100 -button1 "OK" -defaultButton 1
